<x-layout>
    <div class="container-fluid p-5 bg-secondary-subtle text-center">
        <div class="row justify-content-center">
            <div class="col-12">
                <h1 class="display-5">Modifica l'articolo {{ $article->id }}</h1>
            </div>
        </div>
    </div>
            ...
            <div class="col-12 col-md-8">
                <form action="{{ route('article.update', $article) }}" method="POST" class="card p-5 shadow" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="tags" class="form-control" id="tags" value="{{ implode(', ', $article->tags->pluck('name')->toArray()) }}">
                    ...
                    <div class="d-flex justify-content-center flex-column align-items-center">
                        ...
                        <a href="{{ route('homepage') }}" class="btn btn-secondary my-3">Torna alla Home</a>
                    </div>
                </form>
            </div>
        </div>
